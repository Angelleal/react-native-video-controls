...
export default class VideoPlayer extends Component {
   ...
   * current state.
   */
  _toggleControls(value) {
    let state = this.state;
    state.showControls = value ? value : !state.showControls;
  ...
  renderVolume() {
    ...
    return (
        <View style={ styles.volume.container }>
          ...
          >
            <Image style={ styles.volume.icon }
    ...
    return (
        <View style={ styles.seekbar.container }>
          <View
              ...
              onLayout={
                event => this.player.seekerWidth = event.nativeEvent.layout.width }
          >
            <View style={ [
              styles.seekbar.fill,
              {
    ...
    if (this.state.loading) {
      return (
          <View style={ styles.loader.container }>
            <Animated.Image source={ require('./assets/img/loader-icon.png') }
                            style={ [
                              styles.loader.icon,
                              {
                                transform: [
    ...
    if (this.state.error) {
      return (
          <View style={ styles.error.container }>
            <Image source={ require('./assets/img/error-icon.png') }
