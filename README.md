...
Controls for the React Native `<Video>` component at [react-native-video](https://github.com/react-native-community/react-native-video). Replaced ImageBackground with a Combination of older components to mantain comaptibility with React Native versions < 0.45.
